...
** 내가 해결하고 싶던 문제 : 새로 깐 oh my zsh 에서 rubbyrusell log가 딴 페이지로 나올때 문제 해결 : git --no-pager log --oneline --all --graph 
...
![](Untitled-f2c2b5b1-be2c-4141-a60a-944a718a3666.png)

같은 폴더에 전에 올린 파일을 복사하고 파일명만 다르게 한 후, add 하면? (파일명은 다른 데, 내용은 같으면?)

![](Untitled-d36684ac-a79f-4c63-8bc7-d5bd16dc70c7.png)

인덱스의 아이디가 똑같은 양상 (똑같은 컨텐츠가 있기 때문에 암호코드가 똑같음) 

2) 파일명과 내용이 다른 파일을 만들고 add 시킨다면? 

![](Untitled-7ab01349-d985-4c61-a42a-09a58d269ea3.png)
...
![](Untitled-b1cf4aac-d545-4e43-9398-74d8dfc9baae.png)
...
![](Untitled-0d3c3017-818e-4668-9842-42f449a09b75.png)

![](Untitled-8b7b69d9-b1cf-4c08-a597-f35fef58c25a.png)

네이버 데이터 급상승 트랙킹 

![](Untitled-c520bdb8-efca-4940-ac50-b45b6308ce37.png)
...
![](Untitled-40d1fdc0-95eb-4eb3-8871-76c32cef7448.png)
...
![](Untitled-37d7355e-96ba-4c2e-9ca3-a4c613518e95.png)
...
![](Untitled-ee484188-18ac-4cc4-a0b5-d83b094c3237.png)

github 들어가서 repo 만들기

![](Untitled-6f443bec-731e-4133-adad-515527411db9.png)

근데 저장소 주소를 hhtps가 아니라 ssh 로 바꾸기!!!

![](Untitled-2d941155-3068-42ff-921e-506aa417978e.png)
...
![](Untitled-f5e2c22d-294f-4bcf-bc5c-32964ad37759.png)
...
![](Untitled-68081a68-8e2b-4708-8a3d-652ca4dc939b.png)
...
![](Untitled-1ea946b2-4d6b-48cf-8316-6048a7fc6872.png)

git commit만 하고 push를 안하면 생기는 origin/mast, origin_head → 내가 커밋한 게 work3인데 아직 원격 저장소에 올리지 않았다 

![](Untitled-595575fd-142b-4c88-bff7-c278b525f4ca.png)

그러니까 다시 git push

![](Untitled-77aa7685-f4a6-4fa2-9654-e093be6e385b.png)

→ 내가 origin master로 동기화 한 후 새로 한 커밋이 없다 

근데 만약 동시에 push가 되었다면? 

![](Untitled-f598726c-b924-4483-8b44-7acb28d86f7d.png)
...
![](Untitled-05d703a2-4230-4a78-95e8-229dff76f803.png)

***좋은 작업습관 : 작업 전 git pull을 때려본다" 

push / pull 은 습관적으로 많이많이 하다 
