...
def test_grade_scores():
    class_scores = [{'국어': 80, '영어': 100, '수학': 50},
                    {'국어': 90, '영어': 70, '수학': 40}]  # 나는 grade_score함수만 데려온거니까, class_scores 한번 더 알려줘야함
    ...
    assert grade_scores([{'국어': 80, '영어': 100, '수학': 100}, {'국어': 90, '영어': 70, '수학': 0}], 1, '수학') == 'F'
    assert grade_scores([{'국어': 30, '영어': 100, '수학': 100}, {'국어': 70, '영어': 70, '수학': 0}], 1, '국어') == 'B'
    assert grade_scores([{'국어': 80, '영어': 20, '수학': 100}, {'국어': 90, '영어': 50, '수학': 0}], 0, '영어') == 'D'
...
def test_grade_scores2():
    class_scores = [{'국어': 80, '영어': 100, '수학': 50},
                    {'국어': 90, '영어': 70, '수학': 40}]  # 나는 grade_score2 함수만 데려온거니까, class_scores 한번 더 알려줘야함
